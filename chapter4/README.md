...
[**서비스 디자인 패턴**](http://www.servicedesignpatterns.com/WebServiceEvolution) 이라는 책에서는 이러한 문제를 해결하기 위해 웹서비스 진화를 위한 다음과 같은 패턴을 제시한다.
